...
<section class="people-wrap">
  ...
  <section class="extras-section">
    <div class="extras-grid">
      ...
      <!-- Sidebar: Pets -->
      <aside class="extras-aside">
        <h3 class="extras-aside-title">Our Pets</h3>
        <div class="extras-pets">
          <figure class="extras-pet-card">
            <img src="{{ 'images/people/coco.jpeg' | relative_url }}" alt="Coco the cat">
            <figcaption class="extras-pet-name">Coco</figcaption>
          </figure>
          <figure class="extras-pet-card">
            <img src="{{ 'images/people/zoey.jpeg' | relative_url }}" alt="Zoey the dog">
            <figcaption class="extras-pet-name">Zoey</figcaption>
          </figure>
        </div>
      </aside>
    </div>
